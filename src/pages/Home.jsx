 ...
 useEffect(() => {
  ...
  return (
    <div className="space-y-20">
      ...
      {/* Employers Section */}
<section id="employers" className="bg-indigo-50 py-12">
  <div className="max-w-4xl mx-auto px-6 text-center">
    <h2 className="text-4xl font-bold mb-6 text-gray-800">For Employers</h2>
    <p className="mb-4 text-gray-700 text-lg">
      Are you an employer looking for highly trained UK social care workers? 
      Our agency connects skilled professionals with your care facilities.
    </p>
    <p className="text-gray-700 text-lg">
      To collaborate, discuss partnerships, or hire experienced carers, contact us directly at 
      <a href="mailto:ceo@britishirishsocialworkagency.co.uk" className="text-blue-600 hover:underline">
        ceo@britishirishsocialworkagency.co.uk
      </a>.
    </p>
    <p className="mt-4 text-gray-600">
      Together, we ensure that your clients receive professional, safe, and high-quality care.
    </p>
  </div>
</section>
